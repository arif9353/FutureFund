        ...
        <>
            <nav className="flex items-center justify-between px-4 h-[70px] bg-[#1d1f24] w-full">
                ...
                className={"p-2  flex bg-[#00000000] hover:bg-[#22242a] rounded-md items-center gap-2 cursor-pointer relative " + (isDropdownOpen ? "bg-[#282a31]" : "")}>
                    ...
                    {isDropdownOpen && (
                        <>
                            <div className="bg-[#22242a] absolute top-[50px] w-[160px] right-0 text-sm p-3 border border-opacity-40 border-slate-300 rounded-lg">
                                <Link href="logout" className="p-1 px-3 hover:bg-[#2f3139] rounded-[4px]">Profile</Link>

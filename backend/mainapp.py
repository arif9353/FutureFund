...
async def fetch_data():
    try:
        ...
        return JSONResponse(content={'stock': stock_data, 'crypto': crypto_data, 'recurrent_deposit': recurrent_deposit_data, 'gold_data': gold_data,'bonds': bond_data, 'success': True}, status_code=200)

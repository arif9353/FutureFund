...
async def fetch_data():
    try:
        ...
        stock_data = await get_stock_advice('https://m.moneycontrol.com/more_market.php')
        return JSONResponse(content={'stock': stock_data, 'crypto': crypto_data,'success': True}, status_code=200)
